...
const Header: React.FC = () => {
  const headContent = {
    ...
    metaDescription:
      "Particle Auth with Account Abstraction Code demo in Next JS for the Kakarot chain.",
    favicon: "/favicon.ico",
  };
  ...
  const mainHeadingContent = {
    ...
    secondaryLinkHref: "https://www.kakarot.org/",
    secondaryImageSrc: "/kakarot.png",
  ...
  const subHeading =
    "Particle Auth + Account Abstraction SDK + Kakarot Chain demo.";

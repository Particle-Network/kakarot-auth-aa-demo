...
const repositoryLink = {
  href: "https://github.com/soos3d/kakarot-auth-aa-demo",
...
const links = [
  ...
  },
  {
    ...
    title: "Kakarot Documentation →",
    description:
      "Kakarot zkEVM is an Ethereum-compatible rollup built in Cairo.",
  },
  {
    href: "https://sepolia-faucet.kakarot.org/faucet",
    title: "Kakarot Sepolia Faucet →",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        {links.map((link, index) => {
          const isSecondaryLink =
            link.href === "https://docs.kakarot.org/" ||
            link.href === "https://sepolia-faucet.kakarot.org/faucet";
          return (
            <a
              key={index}
              href={link.href}
              ...
              className={`border p-6 rounded-lg hover:bg-gray-800 transition duration-300 ease-in-out transform hover:scale-105 ${
                isSecondaryLink ? "border-orange-500" : "border-purple-500"
              }`}
            >
              <h2
                className={`text-2xl font-semibold mb-2 ${
                  isSecondaryLink ? "text-orange-400" : "text-purple-400"
                }`}
              >
                {link.title}
              </h2>
